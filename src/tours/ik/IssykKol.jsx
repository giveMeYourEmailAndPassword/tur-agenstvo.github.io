...
import issykkul1 from "/img/skazkaImg/issykkul1.jpg";
import issykkul2 from "/img/skazkaImg/issykkul2.jpg";
...
function IssykKul() {
    ...
    let text = `Здравствуйте хотел бы приобрести тур "Иссык-Куль". ${selectedType} в ${selectedMonth} с продолжительностью в ${selectedDay} `
